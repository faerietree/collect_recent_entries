	...
	'columns' => array (
		'type' => array (
			...
			'config'      => array (
				'type'  => 'select',
				'items' => array (
					array('', 0, 'IMAGE', 'TEXT'), // TODO more or derive all possible content element types.
				),
				'foreign_table' => 'tt_content',
				'foreign_field' => ' DISTINCT type',
				'foreign_table_where' => 'AND 1 <> 0',
			)
		),
	),
	'types' => array (
		'0' => array('showitem' => 'collection_id;;;;2-2-2, type;;;;3-3-3')
	),
	'palettes' => array (
		'1' => array('showitem' => '')
	)
	...
	'columns' => array (
		...
		'collection_id' => array (
			'config' => array (
				...
				/*
				'type' => 'user',
				'userFunc' => 'usercollectionfield->getCollectionId' //TODO How to properly handle foreign tables in Extbase?
				*/
			)
		),
	),
